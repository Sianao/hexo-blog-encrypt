...
const knownPrefix = "<hbe-prefix></hbe-prefix>";
  ...
  async function decrypt(decryptKey, iv, hmacKey) {
    ...
    const result = await cryptoObj.subtle.decrypt({
      ...
      document.getElementById('hexo-blog-encrypt').parentElement.appendChild(await convertHTMLToElement(decoded));
      document.removeItem(document.getElementById("hexo-blog-encrypt"))

      // document.getElementById('hexo-blog-encrypt').style.display = 'inline';
      // document.getElementById('hexo-blog-encrypt').innerHTML = '';
      // document.getElementById('hexo-blog-encrypt').parentElement.appendChild(await convertHTMLToElement(decoded));
      // document.getElementById('hexo-blog-encrypt').appendChild(div);
